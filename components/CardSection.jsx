            ...
            <div ref={racesRef} className="scroll-section-inner h-[300px] flex gap-10 w-[150%] items-center races item">
              ...
              <div className="scroll-section">
                <Card
                  ...
                  para="You compare yourself with your peers' achievements, instead of making your self-judgment more independent of others."
              ...
              <div className="scroll-section">
                <Card
                  emoji="😬"
                  heading="You hit a dead end in a negotiation"
